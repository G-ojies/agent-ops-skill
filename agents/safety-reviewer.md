...
**Key custody (`skill/key-custody.md`)**
...
**Correctness (`skill/architecture.md`, `skill/transactions.md`)**
...
- Money verified at `finalized` (`skill/payouts.md`).

**Input trust (`skill/safety.md`)**
